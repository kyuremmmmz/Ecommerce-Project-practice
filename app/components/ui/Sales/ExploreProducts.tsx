...
import ProductsText from '../TypoGraphy/ProductsText';
    ...
    return (
        <div className=' flex'>
            <div className=' flex flex-col gap-3'>
                <ProductsText product={'Explore Products'} description={'Explore Our Products'}/>
                <Swiper
                    modules={[Navigation, Pagination]}
                    spaceBetween={50}
                    slidesPerView={4}
                    navigation
                    className="flex flex-col md:flex-row mt-5 gap-2 items-center md:items-start justify-center md:justify-start w-[1200px]">
                    {list.map((item, index) => {
                        return (
